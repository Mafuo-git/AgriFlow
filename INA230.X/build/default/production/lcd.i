...
# 137 "lcd.c"
    ...
    WaitLCD();
    WriteNibble(1, 0b00000010);
    WriteNibble(1, 0b00001000);
    WaitLCD();
    WriteNibble(1, 0b00000000);
    WriteNibble(1, 0b00001000);
    WaitLCD();
    WriteNibble(1, 0b00000000);
    WriteNibble(1, 0b00001100);

    WaitLCD();
    WriteNibble(1, 0b00000000);
    WriteNibble(1, 0b00000001);
    WaitLCD();
    WriteNibble(1, 0b00000000);
...
{
    if ((row > (2 - 1)) || (column > (16 - 1)))
        return;

    WriteByte(1, (row == 1) ? (0xC0 | column) : (0x80 | column));
    WaitLCD();
}
